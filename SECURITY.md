...
Versions:
* v1.4 (2026-03-26) - Remove collaboration with IBB due to termination of program
...
* [Security Policy for Argo Workflows](https://github.com/argoproj/argo-workflows/blob/main/SECURITY.md)
